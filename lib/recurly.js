(function(){
  var Js2xml = require('js2xml').Js2Xml,
      SubscriptionJs2xml = require('js2xml').Js2Xml,
      Client = require('./client'),
      utils = require('./utils'),
      router = require('./routes/');

  /* Override Pluralisation for Subscriptions */
  SubscriptionJs2xml.prototype.pluralisation = function(name){
  ...
  module.exports = function(config){
    ...
    this.subscriptions = {
      ...
      create: function(details, callback){
        t.request(routes.subscriptions.create, callback, new SubscriptionJs2xml('subscription', details).toString());
      },
      update: function(uuid, details, callback){
        t.request(utils.addParams(routes.subscriptions.update, {uuid: uuid}), callback, new SubscriptionJs2xml('subscription', details).toString());
      },
